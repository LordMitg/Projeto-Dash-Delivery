...
export const PERMISSION_GROUPS: { title: string; keys: Permission[] }[] = [
  { title: 'Operação', keys: ['pdv:use', 'kitchen:view', 'scanner:use'] },
  ...
  { title: 'Financeiro', keys: ['pricing:view', 'pricing:manage', 'reports:view'] },
...
export const ROLE_PRESETS = {
  ...
  cashier: {
    label: 'Caixa',
    permissions: ['pdv:use', 'orders:view', 'customers:view', 'customers:manage', 'scanner:use'],
  },
  waiter: {
    label: 'Garçom',
