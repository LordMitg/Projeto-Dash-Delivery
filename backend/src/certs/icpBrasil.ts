/**
 * Certificado raiz da ICP-Brasil (v10), valido de 2019-07-01 ate 2032-07-01.
 *
 * Embutido como MODULO, e nao como arquivo .pem solto, de proposito: o build
 * do backend e um `tsc` puro, que compila .ts e ignora qualquer outro
 * arquivo. Um .pem em src/certs/ existiria em desenvolvimento e sumiria em
 * producao — e o sintoma seria traicoeiro, porque nada quebra: a consulta a
 * SEFAZ apenas passaria a falhar no handshake e cairia em "lance os itens
 * manualmente" para sempre, como se fosse instabilidade do portal.
 *
 * Origem: https://acraiz.icpbrasil.gov.br/credenciadas/RAIZ/ICP-Brasilv10.crt
 * SHA-256: 6E:0B:FF:06:9A:26:99:4C:15:DE:2C:48:88:CC:54:AF:
 *          84:88:2E:54:95:B7:FB:F6:6B:E9:CC:FF:EC:74:89:F6
 *
 * Para conferir a integridade deste arquivo:
 *   openssl x509 -in <(node -e "...") -noout -fingerprint -sha256
 */
export const ICP_BRASIL_V10_PEM = `
-----BEGIN CERTIFICATE-----
